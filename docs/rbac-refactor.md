...
2. Assign yourself (and other operators):
   - **platform_steward** — diagnostics, SEO health, redirects, content-type schema, private database definitions (not row CRUD)
...
| `platform_steward` | Site health, SEO, content-type schema, database definitions |
