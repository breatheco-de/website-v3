...
describe("pipeline-status", () => {
  ...
  describe("deriveInFlight", () => {
    it("detects index refresh when writes are ahead of applied generation", () => {
      const events = [
        event({ id: 5, type: "content_file_written", resource: { contentType: "page", slug: "home", locale: "en" } }),
      ];
    ...
    it("clears index refresh when lastApplied catches up", () => {
      const events = [
        event({ id: 8, type: "content_file_written", resource: { contentType: "blog", slug: "a", locale: "en" } }),
        event({ id: 9, type: "content_file_written", resource: { contentType: "blog", slug: "b", locale: "en" } }),
    ...
    it("keeps index refresh until snapshot generation is applied", () => {
      const events = [
        event({ id: 10, type: "content_file_written", resource: { contentType: "blog", slug: "a", locale: "en" } }),
